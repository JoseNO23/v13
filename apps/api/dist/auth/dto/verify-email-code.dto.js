...
__decorate([
    (0, class_validator_1.IsString)({ message: 'El codigo es obligatorio.' }),
    (0, class_validator_1.Length)(6, 6, { message: 'El codigo debe tener 6 digitos.' }),
    (0, class_validator_1.Matches)(/^\d{6}$/, { message: 'El codigo debe ser numerico.' }),
    __metadata("design:type", String)
